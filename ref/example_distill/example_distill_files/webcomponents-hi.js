...
*/ (() => {
		((h) => {
			...
			function e() {
				this.a = {};
				this.b = 0;
				this.h = new MutationObserver((b) => this.B(b));
			...
			var w = /(url\()([^)]*)(\))/g,
				...
				g = {
					w: (a, b) => {
						...
						a.src && a.setAttribute("src", g.f(a.getAttribute("src"), b));
					...
					f: (a, b) => {
						...
						c ||
							...
							(g.u = c),
							(c.j = c.createElement("base")),
							c.head.appendChild(c.j),
			...
			e.prototype.c = function (a) {
				k(a.querySelectorAll("link[rel=import]"), (a) => this.m(a));
			};
			...
			e.prototype.C = (a, b) => {
				...
				A &&
					(a = a.replace(y, (a, b, c) =>
						-1 === a.indexOf("type=") ? b + " type=import-disable " + c : a,
					));
				...
				if ((c = a.querySelector("base")))
					(b = g.f(c.getAttribute("href"), b)), c.removeAttribute("href");
				var d = 0;
				k(
					a.querySelectorAll(
			...
			e.prototype.flatten = function (a) {
				k(a.querySelectorAll("link[rel=import]"), (a) => {
					var c = this.a[a.href];
					(a.import = c) &&
			...
			e.prototype.D = (a) => {
				function b(f) {
					if (f < d) {
						...
						k(n.attributes, (a) => e.setAttribute(a.name, a.value));
						B = e;
			...
			e.prototype.A = function () {
				k(document.querySelectorAll("link[rel=import]"), (b) => this.l(b), !0);
			};
			e.prototype.l = (a) => {
				a.__loaded ||
					((a.__loaded = !0),
			...
			e.prototype.B = function (a) {
				k(a, (a) =>
					k(a.addedNodes, (a) => {
						a &&
							a.nodeType === Node.ELEMENT_NODE &&
							(u(a) ? this.m(a) : this.c(a));
					}),
				);
			};
			if (z) {
				k(document.querySelectorAll("link[rel=import]"), (a) => {
				...
				Object.defineProperty(
					(!r || r.configurable ? Node : Element).prototype,
					"baseURI",
					{
						get: function () {
		...
		var l = window.customElements,
			p = window.HTMLImports,
			t = window.HTMLTemplateElement;

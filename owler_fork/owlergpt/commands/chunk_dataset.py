...
def valid_datasets_folder(dataset_path: Path):
    ...
    for parent in _parents:
        ...
        assert (parent / "corpus_train.jsonl").exists() and (parent / "queries_train.jsonl").exists()
        assert (parent / "corpus_validation.jsonl").exists() and (parent / "queries_validation.jsonl").exists()
